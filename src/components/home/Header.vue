  ...
  export default {
    data() {
      return {
        ...
        shopLogo: sessionStorage.$getSessionStorageByName('shopLogo'),
        // encodeURI decodeURI
        username: decodeURI(sessionStorage.$getSessionStorageByName('userName')),
        editPaw: {
          oldPaw: '',
          newPaw: '',
          confirmNewPaw: ''
    ...
    methods: {
      ...
      logout() {
        this.sysLogout().then(() => {
          var loginUrl = sessionStorage.$getSessionStorageByName('shopUrl')
