  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-table :data="financialList" border highlight-current-row element-loading-text="拼命加载中" v-loading="listLoading"
        ...
        <el-table-column prop="type" label="业务类型" width="150"></el-table-column>
        ...
        <el-table-column prop="accountAmount" label="账户总额" width="120"></el-table-column>
        <el-table-column prop="orderInfo" min-width="120" label="业务描述"></el-table-column>
      </el-table>
